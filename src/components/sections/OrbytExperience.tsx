...
function BrowserShot({ src, alt, className = "", preload = false }: ProductShotProps) {
  return (
...
export function OrbytExperience() {
  return (
    <div className="orbyt-page overflow-hidden bg-[#05050e] text-[#eef0ff]">
      <section className="orbyt-hero-scene relative flex min-h-[calc(100svh-4rem)] items-center overflow-hidden pt-16 md:pt-20">
        ...
        <div className="relative mx-auto grid w-full max-w-[92rem] gap-8 px-6 py-10 sm:gap-12 sm:py-16 md:grid-cols-[1fr_0.9fr] md:items-center md:px-10 lg:px-14">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-9 sm:flex-row"><Button href="/contato" variant="orbyt-light">Solicitar demonstração</Button><Button href={siteConfig.orbytUrl} external variant="on-contrast">Acessar o ORBYT</Button></div>
          </div>
      ...
      <section id="modulos" className="relative bg-[#0a0b1a] py-20 md:py-28">
      ...
      <section className="relative overflow-hidden bg-[#060711] py-24 md:py-32">
      ...
      <section className="relative overflow-hidden bg-[#0b0c1d] py-24 md:py-32">
        <div aria-hidden className="absolute left-[10%] top-[20%] h-72 w-72 rounded-full bg-[#7658ff]/20 blur-3xl" />
        <div className="relative mx-auto grid w-full max-w-[92rem] gap-12 px-6 md:grid-cols-[1.1fr_0.9fr] md:items-center md:px-10 lg:px-14">
          <div className="orbyt-product-stage orbyt-product-stage--paired relative order-2 md:order-1"><BrowserShot src="/orbyt-showcase/orbyt-comissao-desktop.webp" alt="Comissões organizadas por competência no ORBYT" className="relative z-10 w-[91%]" /><PhoneShot src="/orbyt-showcase/orbyt-comissao-mobile.webp" alt="Comissões no ORBYT em celular" className="absolute bottom-[-7%] right-[0%] z-20 w-[25%]" /></div>
      ...
      <section className="relative overflow-hidden bg-[#060711] py-24 md:py-32">
        <div aria-hidden className="absolute right-[5%] top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-[#2375ff]/20 blur-3xl" />
        <div className="relative mx-auto grid w-full max-w-[92rem] gap-12 px-6 md:grid-cols-[0.82fr_1.18fr] md:items-center md:px-10 lg:px-14">
          ...
          <div className="orbyt-product-stage orbyt-product-stage--paired relative"><BrowserShot src="/orbyt-showcase/orbyt-caixas-desktop.webp" alt="Visão de caixas e saldos no ORBYT" className="relative z-10 w-[91%]" /><PhoneShot src="/orbyt-showcase/orbyt-caixa-mobile.webp" alt="Visão de caixas do ORBYT em celular" className="absolute bottom-[-7%] right-[0%] z-20 w-[25%]" /></div>
        </div>
      </section>

      <section className="relative bg-[#0b0c1d] py-24 md:py-32">
